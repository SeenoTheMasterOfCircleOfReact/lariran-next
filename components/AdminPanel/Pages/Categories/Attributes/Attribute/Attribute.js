  ...
  return (
    <>
      <div className={classes.holder}>
        <div className={classes.right}>
          ...
          {/* <div className={classes.bottom}>
            ...
            <span className={classes.value}>{attribute.value + " تومان "}</span>
          </div> */}
        </div>
      ...
      <Dialog
        ...
        fullWidth
      >
        <DialogTitle>{`ویرایش مشخصه "${attribute.name}"`}</DialogTitle>
        <DialogContent>
          <sub
            style={{
              color: "red",
      ...
      <Dialog
        ...
        fullWidth
      >
        <DialogTitle>{`حذف مشخصه "${attribute.name}"`}</DialogTitle>
        <DialogContent>
          <sub
            style={{
              color: "red",
